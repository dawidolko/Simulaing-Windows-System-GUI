...
function DesktopContextMenu(props) {
  const handleRefresh = ({ event, props }) => console.log("Super Refreshed !!");
  const navigate = (link) => {
    ...
    <div>
      <Menu id={MENU_ID}>
        <Item
          onClick={() =>
            navigate(
              "https://github.com/dawidolko/Simulaing-Windows-System-GUI/"
            )
          }>
          <img
            src={star}
        ...
        <Separator />
        <Item onClick={() => navigate("https://github.com/dawidolko")}>
          <img
            src={github}
            width="30"
            height="30"
        ...
        <Separator />
        <Item onClick={() => navigate("mailto:poczta@dawidolko.pl")}>
          <img
            src={contact_me}
            width="30"
            height="30"
